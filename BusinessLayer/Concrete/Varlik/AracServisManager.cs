    ...
    public class AracServisManager : IAracServisService
    {
        ...
        public List<AracServis> ExcelDataProcess(DataTable dataTable)
        {
            ...
            for (int i = 1; i < dataTable.Rows.Count; i++)
            {
                ...
                {
                    IsEmriYili = row[0].ToString() != "" ? Convert.ToInt32(row[0].ToString()) : 0,
                    FisNo = row[1].ToString(),
                    TalepEdenID = row[2].ToString() != "" ? Convert.ToInt32(row[2].ToString()) : 0,
                    AracID = row[3].ToString() != "" ? Convert.ToInt32(row[3].ToString()) : 0,
                    GorevID = row[4].ToString() != "" ? Convert.ToInt32(row[4].ToString()) : 0,
                    TalepTarih = row[5].ToString() != "" ? Convert.ToDateTime(row[5].ToString()) : DateTime.MaxValue,
                    TalepSaat = row[6].ToString(),
                    TeslimEtmeTarih = row[7].ToString() != "" ? Convert.ToDateTime(row[7].ToString()) : DateTime.MaxValue,
                    TeslimEtmeSaat = row[8].ToString(),
                    TeslimAlmaTarih = row[9].ToString() != "" ? Convert.ToDateTime(row[9].ToString()) : DateTime.MaxValue,
                    TeslimAlmaSaat = row[10].ToString(),
                    TeslimAlinanKm = row[11].ToString() != "" ? Convert.ToDecimal(row[11].ToString()) : 0,
                    TeslimEdilenKm = row[12].ToString() != "" ? Convert.ToDecimal(row[12].ToString()) : 0,
                    KullanilanKm = row[13].ToString() != "" ? Convert.ToDecimal(row[13].ToString()) : 0,
                    Aciklama = row[14].ToString(),
                    TeslimEdenID = row[15].ToString() != "" ? Convert.ToInt32(row[15].ToString()) : 0,
                    TeslimAlanID = row[16].ToString() != "" ? Convert.ToInt32(row[16].ToString()) : 0,
                    TeslimAmbarID = row[17].ToString() != "" ? Convert.ToInt32(row[17].ToString()) : 0,
                    BolumID = row[18].ToString() != "" ? Convert.ToInt32(row[18].ToString()) : 0,
                    VarlikDurumID = row[19].ToString() != "" ? Convert.ToInt32(row[19].ToString()) : 0,
                    MarkaID = row[20].ToString() != "" ? Convert.ToInt32(row[20].ToString()) : 0,
                    ModelID = row[21].ToString() != "" ? Convert.ToInt32(row[21].ToString()) : 0,
                    SeriNo = row[22].ToString(),
                    ArizaID = row[23].ToString() != "" ? Convert.ToInt32(row[23].ToString()) : 0,
                    HizmetID = row[24].ToString() != "" ? Convert.ToInt32(row[24].ToString()) : 0,
