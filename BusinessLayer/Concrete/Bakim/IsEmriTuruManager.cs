        ...
        public List<IsEmriTuru> ExcelDataProcess(DataTable dataTable)
        {
            ...
            for (int i = 1; i < dataTable.Rows.Count; i++)
            {
                ...
                listIsEmriTuru.Add(new IsEmriTuru()
                {
                    ...
                    TekYilSayac = row[3] != DBNull.Value ? Convert.ToInt32(row[3]+ "") : 0,
                    TekYilBaslangicSayaci = row[4] != DBNull.Value ? Convert.ToInt32(row[4] + "") : 0,
                    CiftYilSayac = row[5] != DBNull.Value ? Convert.ToInt32(row[5] + "") : 0,
                    CiftYilBaslangicSayaci = row[6] != DBNull.Value ? Convert.ToInt32(row[6] + "") : 0,
