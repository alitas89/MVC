...
namespace WebApi.Controllers
{
    public class ZimmetTransferController : ApiController
    {
        ...
        [System.Web.Http.Route("api/zimmettransfer/downloadsablon")]
        public HttpResponseMessage GetExcelSablon()
        {
            List<String> list = new List<String>();
            List<Type> listType = new List<Type>();
            ZimmetTransfer zimmettransfer = new ZimmetTransfer();

            PropertyInfo[] arrProp = zimmettransfer.GetType().GetProperties();
            ...
            MyClassBuilder MCB = new MyClassBuilder("ZimmetTransfer");
        ...
        [System.Web.Http.Route("api/zimmettransfer/uploadsablonexcelfile")]
