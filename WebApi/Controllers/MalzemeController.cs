...
namespace WebApi.Controllers
{
    public class MalzemeController : ApiController
    {
        ...
        [System.Web.Http.Route("api/malzeme/downloadsablon")]
        public HttpResponseMessage GetExcelSablon()
        {
            ...
            PropertyInfo[] arrProp = malzeme.GetType().GetProperties();
            ...
            MyClassBuilder MCB = new MyClassBuilder("Malzeme");
        ...
        [System.Web.Http.Route("api/malzeme/uploadsablonexcelfile")]
        ...
        {
            List<Malzeme> listMalzeme = new List<Malzeme>();
            for (int i = 1; i < dataTable.Rows.Count; i++)
            {
                var row = dataTable.Rows[i].ItemArray;
                //Eklenecek veriler
                listMalzeme.Add(new Malzeme()
                {
                    Kod = row[0].ToString(),
                    Ad = row[1].ToString(),
            ...
            List<string> listMalzemeID = _malzemeService.AddListWithTransactionBySablon(listMalzeme);
