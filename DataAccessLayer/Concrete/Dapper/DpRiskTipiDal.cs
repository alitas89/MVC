...
namespace DataAccessLayer.Concrete.Dapper
{
    public class DpRiskTipiDal : DpEntityRepositoryBase<RiskTipi>, IRiskTipiDal
    {
        ...
        public List<RiskTipi> GetListPagination(PagingParams pagingParams)
        {
            ...
            return GetListQuery($@"SELECT * FROM RiskTipi where Silindi=0 {filterQuery} {orderQuery}
        ...
        public int GetCount(string filterCol = "", string filterVal = "")
        {
            ...
            var strCount = GetScalarQuery($@"SELECT COUNT(*) FROM RiskTipi {where}", new { filterVal }) + "";
