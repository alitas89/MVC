...
namespace DataAccessLayer.Concrete.Dapper.Bakim
{
    public class DpParaBirimDal : DpEntityRepositoryBase<ParaBirim>, IParaBirimDal
    {
        ...
        public List<ParaBirim> GetListPagination(PagingParams pagingParams)
        {
            ...
            return GetListQuery($@"SELECT * FROM ParaBirim where Silindi=0 {filterQuery} {orderQuery}
OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY",
        ...
        public int GetCount(string filterCol = "", string filterVal = "")
        {
            ...
            var strCount = GetScalarQuery($@"SELECT COUNT(*) FROM ParaBirim {where}", new { filterVal }) + "";
