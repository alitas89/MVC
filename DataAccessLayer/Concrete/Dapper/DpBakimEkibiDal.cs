...
namespace DataAccessLayer.Concrete.Dapper
{
    public class DpBakimEkibiDal : DpEntityRepositoryBase<BakimEkibi>, IBakimEkibiDal
    {
        ...
        public List<BakimEkibi> GetListPagination(PagingParams pagingParams)
        {
            ...
            return GetListQuery($@"SELECT * FROM BakimEkibi where Silindi=0 {filterQuery} {orderQuery}
        ...
        public int GetCount(string filterCol = "", string filterVal = "")
        {
            ...
            var strCount = GetScalarQuery($@"SELECT COUNT(*) FROM BakimEkibi {where}", new { filterVal }) + "";
