...
namespace DataAccessLayer.Concrete.Dapper
{
    public class DpArizaCozumuDal : DpEntityRepositoryBase<ArizaCozumu>, IArizaCozumuDal
    {
        ...
        public List<ArizaCozumu> GetListPagination(PagingParams pagingParams)
        {
            ...
            return GetListQuery($@"SELECT * FROM ArizaCozumu where Silindi=0 {filterQuery} {orderQuery}
        ...
        public int GetCount(string filterCol = "", string filterVal = "")
        {
            ...
            var strCount = GetScalarQuery($@"SELECT COUNT(*) FROM ArizaCozumu {where}", new { filterVal }) + "";
